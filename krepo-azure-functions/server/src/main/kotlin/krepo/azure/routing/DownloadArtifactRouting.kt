...
@HttpRouting("/releases/{*path}", methods = [HttpMethod.GET, HttpMethod.HEAD])
...
@HttpRouting("/snapshots/{*path}", methods = [HttpMethod.GET, HttpMethod.HEAD])
...
@HttpRouting("/private/{*path}", methods = [HttpMethod.GET, HttpMethod.HEAD])
